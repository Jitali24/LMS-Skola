...
function Navbar() {
    ...
    // Navbar.handleClickOutside = () => setSearchClick(false);
    ...
    return (
        // <div className={navbar ? 'navbar-outer' : 'navbar-outer active'}>
            <div
                className={
                    navbar ? 'navbar-container' : 'navbar-container active'
                }
            >
                    ...
                    <div class='header__user' onClick={handleUserClick}>
                        ...
                        >
                            ...
                            <div class='popupCard__inner scrollfix-custom'>
                                <div
                                    class='loginSignCard-item active'
                                ...
                                <div
                                    class='loginSignCard-item'
                                    id='loginSignCard-signup'
                                >
                                    <div class='loginSignCard-fix'>
                                        <div class='f-header'>
                                            <h2 class='f-header__title'>
