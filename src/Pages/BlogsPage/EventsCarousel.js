...
function EventsCarousel({ imgSrc, title, link }) {
  return (
    <div className="blog-events-container">
      <div className="events-blog">
        <div className="events-post events-post-new">
          <div className="card-head card-head-new">
            <a href="/">
              <img src={imgSrc} alt="" />
            </a>
