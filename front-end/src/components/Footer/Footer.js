        ...
        <div className="footer-content">
          ...
          <div className="footer-col">
            <div className="footer-col-row">
              <h2>Our Company</h2>
              <div className="footer-menu-btn" onClick={handleClick1}>
                {click1 ? (
          ...
          <div className="footer-col">
            <div className="footer-col-row">
              <h2>Topics</h2>
              <div className="footer-menu-btn" onClick={handleClick2}>
                {click2 ? (
                  <i className="fa-solid fa-minus"></i>
                ) : (
                  <i className="fa-solid fa-plus"></i>
          ...
          <div className="footer-col">
            <div className="footer-col-row">
              <h2>Tracks</h2>
              <div className="footer-menu-btn" onClick={handleClick3}>
                {click3 ? (
                  <i className="fa-solid fa-minus"></i>
                ) : (
                  <i className="fa-solid fa-plus"></i>
          ...
          <div className="footer-col">
            <div className="footer-col-row">
              <h2>Support</h2>
              <div className="footer-menu-btn" onClick={handleClick4}>
                {click4 ? (
                  <i className="fa-solid fa-minus"></i>
                ) : (
                  <i className="fa-solid fa-plus"></i>
